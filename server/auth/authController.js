...
//NO AUTH - render the static signup page for new users
methods.goToSignup = (req, res, next) => {
  res.render('signup');
};

//NO AUTH - after adding new user to db, prompt them to validate email address
...
//BASIC AUTH - sign and send token response for valid users; display api key pair in admin dashboard
...
//BEARER AUTH - after adding new user to db, prompt them to validate email address
